...
- My current Tech Stack is PHP/Laravel on a Legacy Monolith. And a new Micro-Service which is written in Go/Gin.
...
- I am in the process of getting the chancenkarte visa (opportunity card) and awaiting my appointment. After I secure this I am planning to shift to Nuremberg.

# What is your salary expectations?
- My current salary expectations is around EUR 65K per year.